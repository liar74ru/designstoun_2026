...
class MoySkladService
{
    ...
    /**
     * Получить список товаров для просмотра
     */
    public function fetchProductsList($limit = 50): array
    {
        $result = ['products' => [], 'total' => 0, 'error' => null];
        ...
        try {
            ...
            if (!$response->successful()) {
                $result['error'] = 'Ошибка API МойСклад';
                return $result;
            }
