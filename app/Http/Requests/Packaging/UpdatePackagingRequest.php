...
class UpdatePackagingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'result_quantity'        => 'nullable|numeric|min:0.001|required_with:result_product_id',
    ...
    public function messages(): array
    {
        return [
            ...
            'result_quantity.required_with'  => 'Укажите количество товара-результата',
            'result_quantity.min'            => 'Количество результата должно быть больше 0',
