...
@section('content')
    <div class="container py-5">
        ...
        <div class="row g-4">
            ...
            <!-- Плитка Перемещение сырья -->
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <a href="{{ route('raw-batches.index') }}" class="text-decoration-none">
                    <div class="card h-100 shadow-sm hover-shadow transition">
                        <div class="card-body text-center p-4">
                            <div class="display-1 mb-3">📋</div>
                            <h5 class="card-title fw-bold">Перемещение Сырья</h5>
                            <p class="card-text text-muted small">Управление перемещением сырья</p>
                        </div>
                    </div>
                </a>
            </div>
        ...
        <div class="row g-4 mt-2">
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <a href="{{ route('supplier-orders.index') }}" class="text-decoration-none">
                    <div class="card h-100 shadow-sm hover-shadow transition">
                        <div class="card-body text-center p-4">
                            <div class="display-1 mb-3">🚛</div>
                            <h5 class="card-title fw-bold">Поступления сырья</h5>
                            <p class="card-text text-muted small">Заказы поставщикам</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <a href="{{ route('counterparties.index') }}" class="text-decoration-none">
                    <div class="card h-100 shadow-sm hover-shadow transition">
                        <div class="card-body text-center p-4">
                            <div class="display-1 mb-3">🤝</div>
                            <h5 class="card-title fw-bold">Контрагенты</h5>
                            <p class="card-text text-muted small">Поставщики и покупатели</p>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                <a href="{{ route('sync.index') }}" class="text-decoration-none">
                    <div class="card h-100 shadow-sm hover-shadow transition">
                        <div class="card-body text-center p-4">
                            <div class="display-1 mb-3">🔄</div>
                            <h5 class="card-title fw-bold">Синхронизация</h5>
                            <p class="card-text text-muted small">Синхронизация с МойСклад</p>
                        </div>
                    </div>
                </a>
            </div>
